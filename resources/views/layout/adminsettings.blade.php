...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="shortcut icon" type="image/png" href="/admin/images/nairacoinr.png">
    <!-- Custom Stylesheet -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <nav class="navbar navbar-expand-lg navbar-light px-0 justify-content-between">
                            <a class="navbar-brand" href="#"><img src="/admin/images/nairacoinr.png" style="width: 70px; height: 85px;" alt="image">
                            </a>
        ...
        <div class="sidebar">
            <div class="menu">
                <ul>
                    ...
                    <li>
                        <a href="/users" data-toggle="tooltip" data-placement="right" title="All Users">
